  ...
  <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        Or
        <a href="/signup" class="font-medium text-indigo-600 hover:text-indigo-500">create an account</a>
      </p>
    </div>
      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <form class="space-y-6" method="post">
          <div>
            ...
            <div class="mt-1">
              <input id="username" name="username" type="text" autocomplete="username" required class="block w-full appearance-none rounded-md px-3 py-2 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-indigo-500 sm:text-sm <?= isset($errors['username']) ? 'border-2 border-red-400 focus:border-red-500' : 'border border-gray-300 focus:border-indigo-500' ?>">
            </div>
          ...
          <div>
            ...
            <div class="mt-1">
              <input id="password" name="password" type="password" autocomplete="current-password" required class="block w-full appearance-none rounded-md px-3 py-2 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-indigo-500 sm:text-sm <?= isset($errors['password']) ? 'border-2 border-red-400 focus:border-red-500' : 'border border-gray-300 focus:border-indigo-500' ?>">
            </div>
...
<!--          </div>-->
          ...
          <div>
            <button type="submit" class="flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Log in</button>
          </div>
        </form>
